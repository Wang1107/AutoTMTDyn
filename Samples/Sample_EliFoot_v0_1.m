...
joint(2).dof(1).spring = [ springCoeff1 , l_s ] ;
joint(2).dof(1).damp = [ dampViscous1 , 0 ] ;
...
par.t0 = 0 ; par.dt = 150 ; % final tmie: 218
par.stepT = 1e-3 ; % time step for sensor readings is 0.025
